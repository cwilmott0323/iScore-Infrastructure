      ...
      "/accounts-create" : {
        "x-amazon-apigateway-any-method" : {
          ...
          "x-amazon-apigateway-integration" : {
            "httpMethod" : "POST",
            "uri" : "arn:aws:apigateway:us-east-2:lambda:path/2015-03-31/functions/arn:aws:lambda:us-east-2:625580209788:function:iScore-API-2/invocations",
            "responses" : {
              "default" : {
                "statusCode" : "200"
              }
